...
def build_graph():
    ...
    graph.add_node("ml_score_severity",    ml_score_severity)
    ...
    graph.add_edge("classify_failure",     "ml_score_severity")
    graph.add_edge("ml_score_severity",    "investigate_upstream")
